...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-07-2024 a las 19:14:45
...
--
-- Creación: 15-07-2024 a las 17:05:56
--
...
(5, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(6, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(7, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(8, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(9, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(10, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1),
(11, 'Ale', '12342', 'Alexis', 'Sanchez', 'aleariel204@gmail.com', 41534678, '1999-04-24', 1);
...
--
-- Creación: 15-07-2024 a las 17:06:52
--
...
INSERT INTO `students_subjects` (`id`, `id_student`, `id_subject`) VALUES
(1, 10, 1),
(2, 10, 2),
(3, 10, 3),
(4, 10, 4),
...
--
-- Creación: 15-07-2024 a las 17:05:40
--
...
(16, 'Francoo6', '1243', 'Franco', 'Sanchez', 'franco@gmail.com', 45669670, '2005-09-07');
...
--
ALTER TABLE `courses_subjects`
  ADD CONSTRAINT `FK_37651c81-f391-42ac-a8fd-90049161e260` FOREIGN KEY (`id_subject`) REFERENCES `subjects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_445c4808-ee94-4330-953e-53e686aa4071` FOREIGN KEY (`id_course`) REFERENCES `courses` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `students_subjects`
  ADD CONSTRAINT `FK_30300849-e309-4c22-a39c-b93b2f46b5e8` FOREIGN KEY (`id_subject`) REFERENCES `subjects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_bfb4c365-ed40-4e86-af4c-6041fdf206d7` FOREIGN KEY (`id_student`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `students_tasks`
--
ALTER TABLE `students_tasks`
  ADD CONSTRAINT `FK_6d2e4ee4-38dd-42f4-95e7-1d73be381f94` FOREIGN KEY (`id_task`) REFERENCES `tasks` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_b39cadec-f832-4b80-a430-a1a67a9e8c03` FOREIGN KEY (`id_student`) REFERENCES `students` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `subjects_tasks`
--
ALTER TABLE `subjects_tasks`
  ADD CONSTRAINT `FK_151d44d2-d1b5-4dfb-9ce3-e706ac93babf` FOREIGN KEY (`id_subject`) REFERENCES `subjects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_19464e73-ba70-4a9e-a7e9-1e3a2f8f9632` FOREIGN KEY (`id_task`) REFERENCES `tasks` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `teachers_courses`
--
ALTER TABLE `teachers_courses`
  ADD CONSTRAINT `FK_0bdae3ae-c993-431f-b55a-e3e00a8c8292` FOREIGN KEY (`id_teacher`) REFERENCES `teachers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_b54cd076-178e-44d0-908a-1f32d7959990` FOREIGN KEY (`id_course`) REFERENCES `courses` (`id`) ON DELETE CASCADE;

--
-- Filtros para la tabla `teachers_subjects`
--
ALTER TABLE `teachers_subjects`
  ADD CONSTRAINT `FK_3bcbf9df-807d-4057-b6a8-4813fc2adea2` FOREIGN KEY (`id_teacher`) REFERENCES `teachers` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `FK_5bf60774-b1a7-415a-8bbb-e951f1bbfc1d` FOREIGN KEY (`id_subject`) REFERENCES `subjects` (`id`) ON DELETE CASCADE;
COMMIT;
